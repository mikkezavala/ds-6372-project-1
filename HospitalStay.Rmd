...
for (i in c(2:6, 9:11)) {
  idx <- idx + 1
  cur_color <- ifelse(idx == 8, "red", base_palette[idx])
...
>>>>>>> 02313935ab81360b780ebedf124bb60566e14204
...
```{r model-obj-one-test-mdl-outliers-remove}
